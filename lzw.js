...
function compress(input) {
    var table = {};
    var lookup = function(str) { return str.length === 1 ? ord(str) : table[str]; };
...
/**
 * @param input A string with adjacent 16b (hi, lo) values that
 *              constitute a sequence of 32b values.
 */
function decompress(input) {
    var table = {};
    var lookup = function(code) { return code < LIMIT_CHARCODE ? chr(code) : table[code]; };
    var code = LIMIT_CHARCODE;
    var oldCode = input[0];
